...
import ru.st.selenium.logicinterface.TasksTypesLogic;
import ru.st.selenium.logicinterface.TypesOfTablesLogic;
...
public class TaskTypeListObjectPage extends Page implements DirectoriesLogic, TypesOfTablesLogic, TasksTypesLogic {
    ...
    //----------------------------------------------------------------------------------------ТИПЫ ТАБЛИЦ
    /**
     * Добавление нового спр-ка (Администрирование / Типы таблиц)
     *
     * @param typesOfTables
     */
    @Override
