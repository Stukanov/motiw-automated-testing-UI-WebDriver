...
import ru.motiw.web.logicinterface.WebLogic.DirectoriesEditFormLogic;
...
public class DirectoriesEditFormPage extends TaskTypeListObjectPage implements DirectoriesEditFormLogic {
    ...
    public DirectoriesEditFormPage clickSaveObject() {
        saveObject.click();
        BasePage.checkingMessagesConfirmationOfTheObject($(By.xpath("//div[count(div)=3]/div[2]//div[contains(@id,'messagebox') and (@data-errorqtip)]")),
    ...
    public void addSettingsAndFieldDirectories(Directories directories) {
        BasePage.checkDisplayedTabsInTheShapeOfAnObject(By.xpath("//div[count(a)=4]/a//text()//.."), 4,
